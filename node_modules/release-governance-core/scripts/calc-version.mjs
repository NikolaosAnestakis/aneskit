...
const projectRoot = path.resolve(argMap.get("--project-root") || process.env.PROJECT_ROOT || process.cwd());

function run(cmd) {
  return execSync(cmd, { cwd: projectRoot, encoding: "utf8", stdio: ["ignore", "pipe", "pipe"] }).trim();
}
